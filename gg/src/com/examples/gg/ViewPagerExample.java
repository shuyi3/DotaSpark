...
public class ViewPagerExample extends FragmentActivity {
	...
	private void btnAction(int action) {
		switch (action) {
		case 0:
			btn1.setBackgroundResource(R.drawable.d2_selected);
			btn2.setBackgroundResource(R.drawable.d2_unselected);
			btn3.setBackgroundResource(R.drawable.d2_unselected);
			break;

		case 1:
			btn1.setBackgroundResource(R.drawable.d2_unselected);
			btn2.setBackgroundResource(R.drawable.d2_selected);
			btn3.setBackgroundResource(R.drawable.d2_unselected);
			break;
		...
		case 2:
			btn1.setBackgroundResource(R.drawable.d2_unselected);
			btn2.setBackgroundResource(R.drawable.d2_unselected);
			btn3.setBackgroundResource(R.drawable.d2_selected);
			break;
